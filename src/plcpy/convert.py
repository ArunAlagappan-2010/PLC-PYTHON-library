...
from .backends.vendors import codesys as _cds_be   # noqa: F401
from .backends.vendors import twincat as _twc_be   # noqa: F401
from . import plcopen as _plcopen              # noqa: F401  (registers both)
